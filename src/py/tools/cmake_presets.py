...
def get_project_toolchain(path: str = None) -> str:
    ...
    if os.path.isfile(path):
        ...
        return f"# {path}" + textwrap.dedent("""
            ...
            #
            # The lines ending with the comments `#-global-toolchain`, `#-global-include`, `#-local-toolchain`, and `#-local-include` 
            # set the toolchains and include directories for the global and local copies of vcpkg. If MCT needs to update where these
            # files are located, these comments are used to locate the appropriate statements in this file.
            #
            # Don't remove these comments or add anything after them on that line. Otherwise, MCT will not detect these 
            # statements. If this happens, these lines be added (commented out) to the top of the file.
            # 
            # Additionally, don't include anything else on these lines, otherwise MCT may remove your changes. 
            # You may, however, comment these statements out (to disable a specific toolchain, for example). 
            # MCT will watch for this and preserve that commented state if the paths need to be changed.
            #
            # Otherwise, you may edit this file however you wish.
            # =======================================================================================================
